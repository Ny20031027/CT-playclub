...
urlpatterns = [
    ...
    path('orders/<int:order_id>/select-candidate/', views.select_candidate, name='wx-select-candidate'),
    path('orders/<int:order_id>/withdraw/', views.withdraw_application, name='wx-withdraw-application'),
