          ...
          <main v-if="activeGameplay" class="gameplay-editor">
            ...
            >
              <template #section-desc>
                <div class="section-desc-panel">
                  <div>
                    <b>区域小字描述</b>
                    <span>显示在小程序“服务”标题下方</span>
                  </div>
                  <el-input
                    v-model="activeGameplay.service_section_desc"
                    maxlength="200"
                    placeholder="如：选择服务内容"
                    show-word-limit
                  />
                </div>
              </template>
            ...
            <section class="config-section">
              ...
              <div class="section-desc-panel">
                <div>
                  <b>区域小字描述</b>
                  <span>显示在小程序“加购服务”标题下方</span>
                </div>
                <el-input
                  v-model="activeGameplay.addon_section_desc"
                  maxlength="200"
                  placeholder="如：选择一项服务后，还可继续选择相关内容"
                  show-word-limit
                />
              </div>
            ...
            <section class="config-section">
              ...
              <div class="section-desc-panel">
                <div>
                  <b>区域小字描述</b>
                  <span>显示在小程序“更多服务”标题下方</span>
                </div>
                <el-input
                  v-model="activeGameplay.more_service_section_desc"
                  maxlength="200"
                  placeholder="如：可按需要多选"
                  show-word-limit
                />
              </div>
...
const OptionEditor = defineComponent({
  ...
  setup(props, { emit, slots }) {
    return () => h('section', { class: 'config-section' }, [
      ...
      slots['section-desc'] ? slots['section-desc']() : null,
...
.section-desc-panel { display: grid; grid-template-columns: 170px minmax(0, 1fr); gap: 14px; align-items: center; margin: -2px 0 14px; padding: 12px 14px; border: 1px solid #dfe7f6; border-radius: 10px; background: #f7faff; }
.section-desc-panel b { display: block; color: #243047; font-size: 13px; }
.section-desc-panel span { display: block; margin-top: 3px; color: #8a93a3; font-size: 12px; }
